...
import { MapPin, Plus, Filter, Eye, Loader2, MessageSquare, Upload, X, Flame, User, Calendar } from 'lucide-react';
...
// Community marker icon - using gold color
const communityMarkerIcon = new L.Icon({
...
// Event marker icon - using yellow color
